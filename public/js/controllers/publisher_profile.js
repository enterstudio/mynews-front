angular.module('MyNewsApp.Controllers').controller('PublisherProfileController', function PublisherProfileController($scope, $rootScope, $location, $route, Alerts,Preload, Publishers) {
