angular.module('MyNewsApp.Controllers').controller('JournalistProfileController', function JournalistProfileController($scope, $rootScope, $location, $route, Alerts, Preload, Journalists) {
