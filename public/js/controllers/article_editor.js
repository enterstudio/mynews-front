angular.module('MyNewsApp.Controllers').controller('ArticleEditorController', function ArticleEditorController($scope, $rootScope, $sce, Preload, Storage, Alerts, Articles) {
