angular.module('MyNewsApp.Controllers').controller('LiveFeedController', function LiveFeedController($scope, $rootScope, $location, Alerts, ActiveUser, Articles, Loading) {
