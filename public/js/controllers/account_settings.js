angular.module('MyNewsApp.Controllers').controller('AccountSettingsController', function AccountSettingsController($scope, $rootScope, $location, $route, Alerts, Preload, Users) {
