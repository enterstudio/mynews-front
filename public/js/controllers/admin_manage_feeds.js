angular.module('MyNewsApp.Controllers').controller('FeedManagerController', function FeedManagerController($scope, $rootScope, Alerts, Flash, FeedSubscriptions, Loading) {
