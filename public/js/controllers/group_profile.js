angular.module('MyNewsApp.Controllers').controller('GroupProfileController', function GroupProfileController($scope, $rootScope, $location, $route, Alerts, Preload, Groups,Users) {
    $scope.editing = {};
    // --
    // Functions
    // --
